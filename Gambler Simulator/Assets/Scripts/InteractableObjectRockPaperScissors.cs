...
public class InteractableObjectRockPaperScissors : MonoBehaviour
{
    ...
    public RockPaperScissors rockPaperScissorsGame; // Referencja do gry Rock-Paper-Scissors
    ...
    void StartGame()
    {
        ...
        if (rockPaperScissorsGame != null && !rockPaperScissorsGame.isGameActive)
        {
            isGameActive = true; // Set the game as active
            rockPaperScissorsGame.StartGame(); // Start the Rock-Paper-Scissors game
        }
    }
